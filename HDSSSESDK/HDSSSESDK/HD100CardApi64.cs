...
namespace System.Data.HDSSSESDK
{
    ...
    /// 利用管道通信支持64位
    /// </summary>
    internal class HD100CardApi64 : IHD100CardApi, IDisposable
    {
        /// <summary>
        /// 单一实例
        /// </summary>
        ...
        /// SDK文件
        /// </summary>
        public static String SdkFile { get; }
        /// <summary>
        /// 执行目录
        /// </summary>
        ...
        {
            ExeDir = Path.Combine(Directory.GetCurrentDirectory(), "HDSSSEEXE");
            ExeFile = Path.Combine(ExeDir, "NSystem.Data.HDSSSEEXE.exe");
            ...
            {
                File.Copy(Path.Combine(Directory.GetCurrentDirectory(), "HDSSSE32.dll"), SdkFile);
            }
        ...
        private HD100CardApi64()
        {
            ...
            _process.StartInfo.WorkingDirectory = ExeDir;
