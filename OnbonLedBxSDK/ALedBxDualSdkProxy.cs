...
namespace System.Data.OnbonLedBxSDK
{
    ...
    /// 
    /// </summary>
    internal class LedBxDualSdkDllerX64 : ILedBxDualSdkProxy
    {
        /// <summary>
        /// 单例实例
        /// </summary>
        public static LedBxDualSdkDllerX64 Instance { get; } = new LedBxDualSdkDllerX64();
        #region // 函数导入
        /// <summary>
        /// windows平台需要初始化SDK（默认如果没有初始化会自动初始化）
        /// </summary>
        /// <returns></returns>
        [DllImport(LedBxDualSdk.DllFileNameX64, CharSet = CharSet.Unicode)]
    ...
    /// 
    /// </summary>
    internal class LedBxDualSdkDllerX86 : ILedBxDualSdkProxy
    {
        /// <summary>
        /// 单例实例
        /// </summary>
        public static LedBxDualSdkDllerX86 Instance { get; } = new LedBxDualSdkDllerX86();
        #region // 函数导入
        /// <summary>
        /// windows平台需要初始化SDK（默认如果没有初始化会自动初始化）
        /// </summary>
        /// <returns></returns>
        [DllImport(LedBxDualSdk.DllFileNameX86, CharSet = CharSet.Unicode)]
        public static extern int bxDual_InitSdk();
        [DllImport(LedBxDualSdk.DllFileNameX86, CharSet = CharSet.Unicode)]
        public static extern void bxDual_ReleaseSdk();
        /// <summary>
