...
namespace System.Data.YuShiITSSDK
{
    ...
    {
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = ItsNetDevSdk.NETDEV_IPV4_LEN_MAX)]
        public string szIPAddr;                                                              /* IP Device IP */
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = ItsNetDevSdk.NETDEV_USERNAME_LEN_260)]
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = ItsNetDevSdk.NETDEV_MODEL_LEN_64)]
        public string szDevModel;                                                            /* Device model */
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = ItsNetDevSdk.NETDEV_SERIAL_NUMBER_LEN_64)]
