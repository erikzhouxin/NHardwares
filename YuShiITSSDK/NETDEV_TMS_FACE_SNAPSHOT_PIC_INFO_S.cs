...
namespace System.Data.YuShiITSSDK
{
    ...
    public struct NETDEV_TMS_FACE_SNAPSHOT_PIC_INFO_S
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ItsNetDevSdk.NETDEV_TMS_CAMER_ID_LEN)]
        public char[] szCamerID;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ItsNetDevSdk.NETDEV_TMS_FACE_RECORD_ID_LEN)]
        public char[] szRecordID;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ItsNetDevSdk.NETDEV_TMS_FACE_TOLLGATE_ID_LEN)]
        public char[] szTollgateID;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ItsNetDevSdk.NETDEV_TMS_PASSTIME_LEN)]
