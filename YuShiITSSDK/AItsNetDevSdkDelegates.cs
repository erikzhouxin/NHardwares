...
namespace System.Data.YuShiITSSDK
{
    ...
    */
    ...
    /* SDK与设备连接异常/恢复信息数据上报回调函数的指针类型  Exception message/Device status callback function(NEW)
    * @param [IN] lpUserID          用户登录句柄  User login ID
    * @param [IN] ulReportType      消息或者异常消息类型，参见 NETDEV_ITS_STATUS_TYPE_E  Type of message or exception message. See NETDEV_ITS_STATUS_REPORT_E
    * @param [IN] pParam            媒体流句柄  Pointer to the buffer storing exception message
    * @param [IN] lpUserData        用户设置参数,即用户在调用#NETDEV_SetParkStatusCallBack函数时指定的用户参数
    *                               User-set parameters, specified by users when they call the #NETDEV_SetParkStatusCallBack function.
    * @return 无
    * @note 
       1.当ulReportType上报类型为0/1时，对应为设备登录连接状态。使用回调函数上报的登录句柄(lpUserID)可区分设备
       2.当ulReportType上报类型为201/301时，对应为媒体流连接状态。使用回调函数上报的媒体流句柄(lpUserData)可区分设备
       3.用户应及时处理输出的连接异常/恢复信息数据,确保函数尽快返回,否则会影响SDK数据接收处理.
    */
    [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Ansi)]
    public delegate void NETDEV_ParkStatusReportCallBack_PF(IntPtr lpUserID, UInt32 ulReportType, IntPtr pParam, IntPtr lpUserData);

    /**过车抓拍识别数据(包含识别结果、抓拍图片等信息)回调函数的指针类型 Photos upload callback function 
     * @param [IN]  pstPicData          存放过车信息上报数据信息缓冲区指针 Photo data 
     * @param [IN]  lpUserParam         用户设置参数,即用户在调用#NETDEV_StartPicStream函数时指定的用户参数
     *                                   User-set parameters, specified by users when they call the #NETDEV_StartPicStream function. 
     * @note 用户应及时处理输出的过车抓拍识别数据,确保函数尽快返回,否则会影响SDK数据接收处理.
     *  Users should handle output data in a timely manner so that functions can be returned quickly. Otherwise, SDK processing will be affected.
     */
    [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Ansi)]
    public delegate void NETDEV_PIC_UPLOAD_PF(ref NETDEV_PIC_DATA_S pstPicData, IntPtr lpUserData);

    /**车位状态数据回调函数的指针类型  Parking space status callback function 
    * @param [IN]  lpFindHandle            用户登录ID  User login ID
    * @param [IN]  pstParkStatusData   存放车位状态上报数据信息缓冲区指针  Pointer to the buffer storing Parking space status data  
    * @param [IN]  lpUserParam         用户设置参数,即用户在调用#NETDEV_SetParkingStatusCB函数时指定的用户参数
    *                                   User-set parameters, specified by users when they call the #NETDEV_SetParkingStatusCB function.
    * @note 用户应及时处理输出的车位状态数据,确保函数尽快返回,否则会影响SDK数据接收处理.
    *       Users should handle output data in a timely manner so that functions can be returned quickly. Otherwise, SDK processing will be affected.
    */
    [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Ansi)]
    public delegate void NETDEV_PARKING_STATUS_PF(IntPtr lpFindHandle, ref NETDEV_TMS_PARKINGSTATUS_S pstParkStatusData, IntPtr lpUserData);

    internal class DCreater
    {
        public delegate void MemCopy(byte[] dest, IntPtr src, int count);
        ...
        */
        ...
        public delegate IntPtr NETDEV_LoginCloud(String pszCloudSrvUrl, String pszUserName, String pszPassWord);

        public delegate IntPtr NETDEV_LoginCloudDevice_V30(IntPtr lpUserID, ref NETDEV_CLOUD_DEV_LOGIN_INFO_S pstCloudInfo);

        public delegate IntPtr NETDEV_FindCloudDevListEx(IntPtr lpUserID);

        public delegate Int32 NETDEV_FindNextCloudDevInfoEx(IntPtr lpFindHandle, ref NETDEV_CLOUD_DEV_BASIC_INFO_S pstDevInfo);

        public delegate Int32 NETDEV_FindCloseCloudDevListEx(IntPtr lpFindHandle);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfig4(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_OSD_CAP_S lpOutBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfig5(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_VIDEO_STREAM_CAP_EX_S lpOutBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDeviceCapability1(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_OSD_CAP_S lpOutBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDeviceCapability2(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_VIDEO_STREAM_CAP_EX_S lpOutBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        */
        ...
        //         //  public delegate Int32 NETDEV_GetPARKVersion(IntPtr lpszVersion);
        ...
        */
        public delegate Int32 NETDEV_GetDevConfig6(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, IntPtr lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfig7(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_PTZ_STATUS_S lpInBuffer, Int32 dwInBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfig8(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_VIDEO_STREAM_INFO_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfig9(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_IMAGE_SETTING_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfigA(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_SYSTEM_NTP_INFO_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfigB(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_NETWORKCFG_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfigC(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_ALARM_OUTPUT_INFO_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
       ...
       * @note
       */
        public delegate Int32 NETDEV_GetDevConfigD(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_RECORD_PLAN_CFG_INFO_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
       ...
       * @note
       */
        public delegate Int32 NETDEV_GetDevConfigE(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_TRIGGER_ALARM_OUTPUT_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
       ...
       */
         ...
         * @note
         */
        public delegate Int32 NETDEV_GetDevConfigQ(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_VIDEO_OSD_CFG_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfigF(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_ALARM_INPUT_LIST_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
         ...
         * @note
         */
        public delegate Int32 NETDEV_GetDevConfigG(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_ALARM_OUTPUT_LIST_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
         ...
         * @note
         */
        public delegate Int32 NETDEV_GetDevConfigH(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_DEVICE_BASICINFO_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);

        public delegate Int32 NETDEV_GetDevConfigI(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_DISK_INFO_LIST_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfigJ(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_PRIVACY_MASK_CFG_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
         ...
         * @note
         */
        public delegate Int32 NETDEV_SetDevConfigF(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_PRIVACY_MASK_CFG_S lpInBuffer, Int32 dwInBufferSize);
         ...
         * @note
         */
        public delegate Int32 NETDEV_GetDevConfigK(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_SYSTEM_NTP_INFO_LIST_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        * @note
        */
        public delegate Int32 NETDEV_GetDevConfigL(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_IMAGE_EXPOSURE_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
         ...
         * @note
         */
        public delegate Int32 NETDEV_SetDevConfigG(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_IMAGE_EXPOSURE_S lpInBuffer, Int32 dwOutBufferSize);
        ...
        /**
          ...
          * @note
          */
        public delegate Int32 NETDEV_GetDevConfigM(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_IRCUT_FILTER_INFO_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        public delegate Int32 NETDEV_GetDevConfigN(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_INFORELEASE_CFG_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);

        public delegate Int32 NETDEV_SetDevConfigI(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_INFORELEASE_CFG_S lpInBuffer, Int32 dwInBufferSize);
        ...
        /**
          ...
          * @note
          */
        public delegate Int32 NETDEV_GetDevConfigO(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_ITS_PARKING_DETECTION_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
        ...
        /**
          ...
          * @note
          */
        public delegate Int32 NETDEV_GetDevConfigP(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_OSD_CONTENT_STYLE_S lpInBuffer, Int32 dwOutBufferSize, ref int pdwBytesReturned);
         ...
         * @note
         */
        public delegate Int32 NETDEV_SetDevConfigJ(IntPtr lpUserID, Int32 dwChannelID, Int32 dwCommand, ref NETDEV_OSD_CONTENT_STYLE_S lpInBuffer, Int32 dwInBufferSize);
        ...
        * @note
        */
        public delegate Int32 NETDEV_ConfigLogFile(Int32 dwLogFileSize, Int32 dwLogFileNum);
        ...
        */
        public delegate Int32 NETDEV_SetPlayDecodeVideoCB(IntPtr lpRealHandle, ref NETDEV_DECODE_VIDEO_DATA_CALLBACK_PF cbPlayDecodeVideoCallBack, Int32 bContinue, IntPtr lpUserData);
        // public delegate Int32 NETDEV_SetPlayDecodeVideoCB(IntPtr lpRealHandle, IntPtr cbPlayDecodeVideoCallBack, Int32 bContinue, IntPtr lpUserData);
        ...
        * - To shut the callback function, set the second parameter as NULL.
        */
        public delegate Int32 NETDEV_SetPlayParseCB(IntPtr lpRealHandle, ref NETDEV_PARSE_VIDEO_DATA_CALLBACK_PF cbPlayParseCallBack, Int32 bContinue, IntPtr lpUserData);
        ...
        */
        ...
        public delegate Int32 NETDEV_GetCloudDevInfoByName(IntPtr lpUserID, String pszRegisterCode, ref NETDEV_CLOUD_DEV_INFO_S pstDevInfo);

        public delegate Int32 NETDEV_GetCloudDevInfoByRegCode(IntPtr lpUserID, String pszRegisterName, ref NETDEV_CLOUD_DEV_INFO_S pstDevInfo);
        ...
        */
        ...
        public delegate IntPtr NETDEV_FindMonitorDevResult(IntPtr lpUserID, ref UInt32 pudwDevNum);

        public delegate Int32 NETDEV_FindNextMonitorDevResult(IntPtr lpFindHandle, ref NETDEV_MONITOR_DEV_RESULT_INFO_S pstMonitorDevResultInfo);

        public delegate Int32 NETDEV_FindCloseMonitorDevResult(IntPtr lpFindHandle);
        ...
        */
        public delegate Int32 NETDEV_GetPARKVersion(byte[] strVersion);
       ...
       * @note  
       */
        public delegate Int32 NETDEV_SetParkStatusCallBack(IntPtr lpUserID, NETDEV_ParkStatusReportCallBack_PF cbParkStatusReportCallBack, IntPtr lpUserData);
        ...
        * @note 
        */
        public delegate IntPtr NETDEV_StartPicStream(IntPtr lpUserID, IntPtr hPlayWnd, bool bReTran, string pcReTranIP, NETDEV_PIC_UPLOAD_PF pfnPicDataCBFun, IntPtr lpUserData);
         ...
         */
        public delegate Int32 NETDEV_StopPicStream(IntPtr lpPlayHandle);
        ...
        * @note None
        */
        public delegate Int32 NETDEV_Trigger(IntPtr lpFindHandle);
        ...
        * @note None
        */
        public delegate Int32 NETDEV_TriggerSync(IntPtr lpFindHandle, ref IntPtr ppstPicData);
        ...
        */
        public delegate Int32 NETDEV_SetOutputSwitchStatusCfg(IntPtr lpFindHandle);
         ...
         */
        public delegate Int32 NETDEV_ImportBlackWhiteListFile(IntPtr lpFindHandle, String pcFile);
         ...
         * @note 文件路径示例:“C:\车辆设备黑白名单模板\ GateBlacklist.csv”,黑名单文件命名(GateBlacklist.csv),白名单文件命名(GateWhitelist.csv)
         */
        public delegate Int32 NETDEV_ExportBlackWhiteListFile(IntPtr lpFindHandle, String pcFile);
         ...
         * @note 无 None
         */
        public delegate Int32 NETDEV_AddVehicleRecord(IntPtr lpFindHandle, ref NETDEV_PARK_VEHICLE_RECORD_EXTERN_S pstVehicleRecordExtern);
         ...
         * @note 无 None
         */
        public delegate Int32 NETDEV_ModifyAllowVehicleRecord(IntPtr lpFindHandle, ref NETDEV_PARK_VEHICLE_RECORD_S pstVehicleRecordExtern);
         ...
         * @note 无 None
         */
        public delegate Int32 NETDEV_ModifyBlockVehicleRecord(IntPtr lpFindHandle, ref NETDEV_PARK_VEHICLE_RECORD_S pstVehicleRecordExtern);
         ...
         * @note 无
         */
        public delegate Int32 NETDEV_DeleteAllowVehicleRecord(IntPtr lpFindHandle, Int32 ulRecordID);
         ...
         * @note 无
         */
        public delegate Int32 NETDEV_DeleteBlockVehicleRecord(IntPtr lpFindHandle, Int32 ulRecordID);
         ...
         */
        public delegate Int32 NETDEV_setDeviceLedCfg(IntPtr lpFindHandle, ref NETDEV_LED_LIST_CFG_S pstLedListCfgs);
        ...
        * @note 
        */
        public delegate Int32 NETDEV_GetBuiltinIndicatorCtrl(IntPtr lpFindHandle, ref NETDEV_CARPORT_CONTROLLED_S pstuCarportControlled);
        ...
        * @note 
        */
        public delegate Int32 NETDEV_SetBuiltinIndicatorCtrl(IntPtr lpFindHandle, ref NETDEV_CARPORT_CONTROLLED_S pstuCarportControlled);
         ...
         * @note None
         */
        public delegate Int32 NETDEV_EnableCarplate(Int32 bEnable);
        ...
        * @note  
        */
        public delegate Int32 NETDEV_SetParkingStatusCB(IntPtr lpFindHandle, NETDEV_PARKING_STATUS_PF pfnParkStatusCBFun, IntPtr lpUserData);
    }
}
