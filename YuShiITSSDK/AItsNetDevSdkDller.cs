...
{
    internal class ItsNetDevSdkDllerX64 : IItsNetDevSdkProxy
    {
        public static IItsNetDevSdkProxy Instance { get; } = new ItsNetDevSdkDllerX64();
        private ItsNetDevSdkDllerX64() { }
        [DllImport("msvcrt.dll", EntryPoint = "memcpy", CallingConvention = CallingConvention.Cdecl, SetLastError = false)]
        public static extern void MemCopy(byte[] dest, IntPtr src, int count);
        [DllImport("kernel32.dll", CharSet = CharSet.Auto)]
        public static extern void OutputDebugString(string message);

        [DllImport(ItsNetDevSdk.DllFileNameX64, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
    ...
    internal class ItsNetDevSdkDllerX86 : IItsNetDevSdkProxy
    {
        public static IItsNetDevSdkProxy Instance { get; } = new ItsNetDevSdkDllerX86();
        private ItsNetDevSdkDllerX86() { }
        [DllImport("msvcrt.dll", EntryPoint = "memcpy", CallingConvention = CallingConvention.Cdecl, SetLastError = false)]
        public static extern void MemCopy(byte[] dest, IntPtr src, int count);
        [DllImport("kernel32.dll", CharSet = CharSet.Auto)]
        public static extern void OutputDebugString(string message);

        [DllImport(ItsNetDevSdk.DllFileNameX86, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 NETDEV_SetFaceSnapshotCallBack(IntPtr lpUserID, NETDEV_FaceSnapshotCallBack_PF cbFaceSnapshotCallBack, IntPtr lpUserData);
