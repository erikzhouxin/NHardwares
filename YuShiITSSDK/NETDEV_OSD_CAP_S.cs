...
namespace System.Data.YuShiITSSDK
{
    ...
    public struct NETDEV_OSD_CAP_S
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ItsNetDevSdk.NETDEV_OSD_DATE_FORMAT_MAX_NUM)]
        public Int32[] aduwSupportedDateFormatList;                                          /* 日期OSD格式列表，参见枚举NETDEV_OSD_DATE_FORMAT_E See# NETDEV_OSD_TIME_FORMAT_E */

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ItsNetDevSdk.NETDEV_OSD_TIME_FORMAT_MAX_NUM)]
        public Int32[] audwSupportedTimeFormatList;       /*时间OSD格式列表，参见枚举NETDEV_OSD_TIME_FORMAT_E See# NETDEV_OSD_TIME_FORMAT_E */

        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ItsNetDevSdk.NETDEV_OSD_TYPE_MAX_NUM)]
