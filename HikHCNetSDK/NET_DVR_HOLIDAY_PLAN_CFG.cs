...
namespace System.Data.HikHCNetSDK
{
    ...
    public struct NET_DVR_HOLIDAY_PLAN_CFG
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = HikHCNetSdk.MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
        ...
        public void Init()
        {
            struPlanCfg = new NET_DVR_SINGLE_PLAN_SEGMENT[HikHCNetSdk.MAX_TIMESEGMENT_V30];
