...
namespace VzClientSDK.WinForm
{
    public partial class Form1 : Form
    {
                                                  ...
                                                  IntPtr pImgPlateClip)
        {
            ...
            {
                if (eResultType == VZ_LPRC_RESULT_TYPE.VZ_LPRC_RESULT_VLOOP_TRIGGER)
                {
        ...
        private void btnSerial_Click(object sender, EventArgs e)
        {
            ...
            if (m_hLPRClient > 0)
            {
                ...
                VZ_DEV_SERIAL_NUM vzDevSerialNum = (VZ_DEV_SERIAL_NUM)Marshal.PtrToStructure(pBuff, typeof(VZ_DEV_SERIAL_NUM));

                VzClientSDK.VzLPRClient_GetSerialNumber(m_hLPRClient, ref vzDevSerialNum);
