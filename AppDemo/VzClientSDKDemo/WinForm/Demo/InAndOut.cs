...
namespace VzClientSDK.WinForm
{
    public partial class InAndOut_Form : Form
    {
        ...
        private VZ_OutputConfigInfo m_oOutputInfo = new VZ_OutputConfigInfo();
        ...
        {
            int nType = (int)VZ_InputType.nWhiteList;
        ...
        {
            int nType = (int)VZ_InputType.nNotWhiteList;
            m_oOutputInfo.oConfigInfo[nType].switchout1 = ConvertToInt(sender);
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            VZ_SERIAL_PARAMETER oSerialParam = new VZ_SERIAL_PARAMETER();
        ...
        {
            int nType = (int)VZ_InputType.nNoLicence;
            m_oOutputInfo.oConfigInfo[nType].switchout1 = ConvertToInt(sender);
        }
        ...
        {
            int nType = (int)VZ_InputType.nBlackList;
            m_oOutputInfo.oConfigInfo[nType].switchout1 = ConvertToInt(sender);
        }
        ...
        {
            int nType = (int)VZ_InputType.nExtIoctl1;
            m_oOutputInfo.oConfigInfo[nType].switchout1 = ConvertToInt(sender);
        }
        ...
        {
            int nType = (int)VZ_InputType.nExtIoctl2;
            m_oOutputInfo.oConfigInfo[nType].switchout1 = ConvertToInt(sender);
        }
        ...
        {
            int nType = (int)VZ_InputType.nExtIoctl3;
            m_oOutputInfo.oConfigInfo[nType].switchout1 = ConvertToInt(sender);
        }
