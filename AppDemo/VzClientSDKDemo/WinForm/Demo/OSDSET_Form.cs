...
namespace VzClientSDK.WinForm
{
    public partial class OSDSET_Form : Form
    {
        ...
        VZ_LPRC_OSD_Param osdParam = new VZ_LPRC_OSD_Param();
        ...
        public void SetLPRHandle(IntPtr m_hLPRClient_)
        {
            ...
            osdParam = (VZ_LPRC_OSD_Param)Marshal.PtrToStructure(intptr, typeof(VZ_LPRC_OSD_Param));
        ...
        private void savebtn_Click(object sender, EventArgs e)
        {
            ...
            {
                VZ_DATE_TIME_INFO TimeInfo = new VZ_DATE_TIME_INFO();
