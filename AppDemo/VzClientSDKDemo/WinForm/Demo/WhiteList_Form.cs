...
namespace VzClientSDK.WinForm
{
    public partial class WhiteList_Form : Form
    {
        ...
        private VZ_LPR_WLIST_VEHICLE[] m_arrVehicle;
        private VZ_LPR_WLIST_ROW[] m_arrWlistRow;
        private VZ_LPR_WLIST_IMPORT_RESULT[] m_arrImportResult;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            m_arrVehicle = new VZ_LPR_WLIST_VEHICLE[IMPORT_COUNT];
            m_arrWlistRow = new VZ_LPR_WLIST_ROW[IMPORT_COUNT];
        ...
        public void SearchText(int nPageIndex)
        {
            ...
            limit.limitType = VZ_LPR_WLIST_LIMIT_TYPE.VZ_LPR_WLIST_LIMIT_TYPE_RANGE;

            //limit.pRangeLimit = null;
            // 起始范围的定义
            VZ_LPR_WLIST_RANGE_LIMIT rangLimit = new VZ_LPR_WLIST_RANGE_LIMIT();
            ...
            limit.pRangeLimit = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(VZ_LPR_WLIST_RANGE_LIMIT)));
        ...
        private  void dtToWL(DataTable dt)
        {
            ...
            {
                m_arrWlistRow[k].pVehicle = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(VZ_LPR_WLIST_VEHICLE)));
