    ...
    namespace LedSDKDemo_CSharp
    {
        ...
        class Dynamic_5
        {
            ...
            public static void Updata_dynamic_txt()
            {
                ...
                if (Program.check)
                {
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaWithTxt_5G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_SINGLE, uAreaId, RunMode, Timeout, RelateAllPro, RelateProNum, RelateProSerial,
                ...
                {
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaWithTxt_5G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, uAreaId, RunMode, Timeout, RelateAllPro, RelateProNum, RelateProSerial,
                                    ImmePlay, uAreaX, uAreaY, uWidth, uHeight, oFrame, DisplayMode, ClearMode, Speed, StayTime, RepeatTime, oFont, fontName, strAreaTxtContent);
                    //功能一样，只是结构体为指针参数
            ...
            public static void Updata_dynamic_png()
            {
                ...
                if (Program.check)
                {
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaWithPic_5G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, uAreaId, RunMode, Timeout, RelateAllPro, RelateProNum, RelateProSerial,
                    ImmePlay, uAreaX, uAreaY, uWidth, uHeight, oFrame, DisplayMode, ClearMode, Speed, StayTime, RepeatTime, filePath);
                }
                //串口
                else
                {
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaWithPic_5G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, uAreaId, RunMode, Timeout, RelateAllPro, RelateProNum, RelateProSerial,
                    ImmePlay, uAreaX, uAreaY, uWidth, uHeight, oFrame, DisplayMode, ClearMode, Speed, StayTime, RepeatTime, filePath);
                }
            ...
            public static void updata_dynamic_pages()
            {
                ...
                if (Program.check)
                {
                    ...
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaInfos_5G_Point(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, uAreaId, RunMode, Timeout, RelateAllPro, RelateProNum, RelateProSerial,
                    ImmePlay, uAreaX, uAreaY, uWidth, uHeight, oFrame, (byte)Params.Length, Params);
                }
                //串口
                else
                {
                    //该接口调用报错
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaInfos_5G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, uAreaId, RunMode, Timeout, RelateAllPro, RelateProNum, RelateProSerial,
                                    ImmePlay, uAreaX, uAreaY, uWidth, uHeight, oFrame, (byte)Params.Length, Params);
                }
            ...
            public static void updata_tests(int id, int x, int y, int w, int h, string text)
            {
                ...
                err = bxdualsdk.BxDual_dynamicArea_AddAreaInfos_5G_Point(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, uAreaId, 0, 10, 1, 0, RelateProSerial,
        ...
        class Dynamic_6
        {
            ...
            public static void delete_dynamic()
            {
                ...
                {
                    err = bxdualsdk.BxDual_dynamicArea_DelArea_6G_Serial(Program.com, Program.baudRate, 0xff);
                }
            ...
            public static void delete_dynamic_s()
            {
                ...
                {
                    id = new byte[] { 0 };
                    err = bxdualsdk.BxDual_dynamicArea_DelAreas_6G_Serial(Program.com, Program.baudRate, (byte)id.Length, id);
                }
                Console.WriteLine("dynamicArea_DelArea = " + err);
            }
            ...
            public static void dynamicArea_str_1()
            {
                ...
                err = bxdualsdk.BxDual_dynamicArea_AddAreaTxt_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId, AreaX, AreaY,
            ...
            public static void dynamicArea_str_2()
            {
                ...
                if (Program.check)
                {
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaTxtDetails_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_SINGLE, AreaId,
                        ref aheader, ref pheader, fontName1, strAreaTxtContent1);
                }
                //串口
                else
                {
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaTxtDetails_6G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE,
            ...
            public static void dynamicArea_str_3()
            {
                ...
                if (Program.check)
                {
                    ...
                    //是否关联节目
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaTxtDetails_WithProgram_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId,
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaTxtDetails_6G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId,
                        ref aheader, ref pheader, fontName, strAreaTxtContent);
                    //是否关联节目
            ...
            public static void dynamicArea_str_31()
            {
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaTxtDetails_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, 1,
                       ref aheader, ref pheader, fontName, strAreaTxtContent);
                    //是否关联节目
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaTxtDetails_6G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_SINGLE, AreaId,
                        ref aheader, ref pheader, fontName, strAreaTxtContent);
                    //是否关联节目
                    //err = bxdualsdk.BxDual_dynamicArea_AddAreaTxtDetails_WithProgram_6G_Serial(Program.com, Program.baudRate, bxdualsdk.E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId,
                    //ref aheader, ref pheader, fontName, strAreaTxtContent, RelateProNum, RelateProSerial);
            ...
            public static void dynamicArea_str_4()
            {
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaTxtDetails_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_THREE, AreaId,
                        ref aheader, ref pheader, fontName, strAreaTxtContent);
                    //是否关联节目
            ...
            public static void dynamicArea_png_1()
            {
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaPic_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId, AreaX, AreaY,
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaPic_6G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId, AreaX, AreaY,
            ...
            public static void dynamicArea_str_5()
            {
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicAreaS_AddTxtDetails_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, (byte)Params.Length, Params);
                    //是否关联节目
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicAreaS_AddTxtDetails_6G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, (byte)Params.Length, Params);
                    //是否关联节目
            ...
            public static void dynamicArea_png_2()
            {
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicAreaS_AddAreaPic_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, (byte)Params.Length, Params);
                    //是否关联节目
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicAreaS_AddAreaPic_6G_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, (byte)Params.Length, Params);
                    //是否关联节目
            ...
            public static void dynamicArea_pages()
            {
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaInfos_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId, RunMode, Timeout, RelateAllPro,
                ...
                {
                    //动态区优先播放，节目停止播放
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaInfos_G6_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId, RunMode, Timeout, RelateAllPro,
                 RelateProNum, RelateProSerial, ImmePlay, AreaX, AreaY, Width, Height, Frame, (byte)Params.Length, ref Params);
                }
            ...
            public static void dynamicArea_pages_1()
            {
                ...
                if (Program.check)
                {
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaInfos_6G_V2(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_THREE, AreaId, RunMode, Timeout, RelateAllPro,
                 RelateProNum, RelateProSerial, ImmePlay, AreaX, AreaY, Width, Height, Frame, (byte)Params.Length, Params, ref stSoundData);
                }
                //串口
                else
                {
                    err = bxdualsdk.BxDual_dynamicArea_AddAreaInfos_6G_V2_Serial(Program.com, Program.baudRate, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, AreaId, RunMode, Timeout, RelateAllPro,
        ...
        class Server
        {
            ...
            private static void SendTextMsg(int port)
            {
                ...
                try
                {
                    ...
                    //网口
                    //动态区优先播放，节目停止播放
                    int err = bxdualsdk.BxDual_dynamicArea_AddAreaPic_6G(Program.ip, Program.port, E_ScreenColor_G56.eSCREEN_COLOR_DOUBLE, 0, 0, 0,
